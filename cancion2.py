...
notas = {'V': 0, 'G3': 196, 'B3': 247, 'C4':262 ,'C#4': 277, 'D4': 294, 'E4': 330, 'F4': 349, 
         'F#4': 370, 'G4': 392, 'A4': 440, 'B4': 494, 'C5': 523, 'D5': 587}
...
# Tocar el fragmento de Take On Me de A-ha
notas_fragmento = ['A4', 'A4', 'F4', 'D4', 'V', 'D4', 'V', 'G4',
                   'V', 'G4', 'V', 'G4', 'B4', 'B4', 'C5', 'D5',
                   'C5', 'C5', 'C5', 'G4', 'V', 'F4', 'V', 'A4',
                   'V', 'A4', 'V', 'A4', 'G4', 'G4', 'A4', 'G4',
                   'A4', 'A4', 'F4', 'D4', 'V', 'D4', 'V', 'G4',
                   'V', 'G4', 'V', 'G4', 'B4', 'B4', 'C5', 'D5',
                   'C5', 'C5', 'C5', 'G4', 'V', 'F4', 'V', 'A4',
                   'V', 'A4', 'V', 'A4', 'G4', 'G4', 'A4', 'G4',
                   'A4', 'A4', 'F4', 'D4', 'V', 'D4', 'V', 'G4',
                   'V', 'G4', 'V', 'G4', 'B4', 'B4', 'C5', 'D5',
                   'C5', 'C5', 'C5', 'A4', 'V', 'F4', 'V', 'A4',
                   'V', 'A4', 'V', 'A4', 'G4', 'G4']
